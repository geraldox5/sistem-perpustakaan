                ...
                <form method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select select2" id="id_anggota" name="id_anggota" required>
                            ...
                            <small class="form-text text-muted">Ketik untuk mencari anggota</small>
                        </div>
                        <div class="mb-3">
                            <label for="id_buku" class="form-label">Buku</label>
                            <select class="form-select select2" id="id_buku" name="id_buku" required>
                                <option value="">Pilih Buku</option>
                                <?php 
                                mysqli_data_seek($result_buku, 0);
                            ...
                            <small class="form-text text-muted">Ketik untuk mencari buku</small>
                        </div>
                        <div class="mb-3">
